...
class ItemModel {
  ...
  ItemModel.fromJson(Map<String, dynamic> json) {
    ...
    isLike = json['is_liked'] == 1;
    isFeature = json['is_feature'] == 1;
    created = json['created_at'];
    itemType = json['item_type'];
    userId = json['user_id'];
    categoryId = json['category_id'];
    isAlreadyOffered = json['is_already_offered'] == 1;
    isAlreadyReported = json['is_already_reported'] == 1;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_liked'] = isLike == true ? 1 : 0;
    data['is_feature'] = isFeature == true ? 1 : 0;
    data['created_at'] = created;
    data['item_type'] = itemType;
    data['user_id'] = userId;
    data['category_id'] = categoryId;
    data['is_already_offered'] = isAlreadyOffered == true ? 1 : 0;
    data['is_already_reported'] = isAlreadyReported == true ? 1 : 0;
