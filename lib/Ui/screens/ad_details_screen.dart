...
import '../../data/model/CustomField/custom_field_model.dart';
...
/*  late final String from =
          ...
          GridListAdapter(
            ...
            builder: (context, int index, bool) {
              ...
              if (item.id != model.id) {
                return ItemCard(
                  item: item,
                  width: MediaQuery.sizeOf(context).width / 2.1.rw(context),
                );
              } else {
                return const SizedBox.shrink();
              }
  ...
  Widget valueContent(CustomFieldModel field) {
    List<dynamic>? value = field.value;
