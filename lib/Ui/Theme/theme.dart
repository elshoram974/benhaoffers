...
const Color territoryColor_ = Color(0xFFf83535);
...
const Color territoryColorDark = Color(0xfff83535);
...
///Messages Color
const Color errorMessageColor = Color(0xFFA60404); // Color(0xffeb5479)
const Color successMessageColor = Color(0xfff83535);
const Color warningMessageColor = Color(0xFFC2AF6F);

//status button color
const Color pendingButtonColor = Color(0xFF9A1414);
