...
const Color territoryColor_ = Color(0xFF418342);
...
const Color territoryColorDark = Color(0xff418342);
...
const Color successMessageColor = Color(0xff418342);
const Color warningMessageColor = Color(0xFFC2AF6F);

//status button color
const Color pendingButtonColor = Color(0xFF326633);
